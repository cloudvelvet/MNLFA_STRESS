...
readme <- paste0(
  ...
  "The estimates below pool selected draws from four mean-field variational inference fits using complete covariate cases.\n\n",
...
html <- paste0(
  ...
  "<div class=\"note\"><strong>Primary specification.</strong> Wave enters only the latent growth equation. Measurement DIF uses Korean proficiency, income, and discrimination. Results pool selected draws from four mean-field VI fits.</div>",
  "<h2>Estimation, priors, and data handling</h2><ul>",
  "<li><strong>Approximation:</strong> Four mean-field VI optimizations used 15,000 iterations, 50 ELBO samples per evaluation, and 1,000 output samples. No same-specification no-wave NUTS confirmation is claimed.</li>",
  "<li><strong>Diagnostic record:</strong> Four-seed slope stability is archived. ELBO traces and PSIS diagnostics are not archived in this release and are not presented as completed validation.</li>",
  "<li><strong>Missing covariates:</strong> Complete-case analysis excluded 136 of 77,296 response rows with missing log-income, yielding 77,160 analyzed responses from 2,190 parents. This is not FIML or multiple imputation.</li>",
  "<li><strong>Retention:</strong> W1 2,183; W2 1,992; W3 1,914; W4 1,808; W5 1,748 parents.</li>",
  "<li><strong>DIF specification:</strong> All item-by-covariate loading and threshold effects were jointly estimated; no hard anchor item or modification-index/post-hoc item selection was used.</li>",
  "<li><strong>Regularizing priors:</strong> loading DIF Normal(0, 0.20); threshold DIF Normal(0, 0.35); latent-state covariate effects Normal(0, 0.35).</li></ul>",
