// Alternative MAPS longitudinal ordinal MNLFA.
//
// This competing specification allows time-varying covariates to predict the
// latent state while still allowing the same covariates to moderate item
// loadings and thresholds. It is intended as a robustness check against the
// criticism that discrimination-related change is forced into measurement DIF.
